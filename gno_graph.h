...
public:
    ...
    virtual const std::vector<graph::uid> &edges_started_on (const uid node_uid) const = 0;
...
public:
    ...
    virtual const std::vector<graph::uid> &edges_started_on (const uid node_uid) const { return m_start_map[node_uid]; }
