...
//    }
    ...
    //fill options
    {
...

        {
            ...
            fill_layout->addWidget (m_load_default_5_button = new QPushButton ("Rombe Graph with Edge", this));
            fill_layout->addWidget (m_load_default_6_button = new QPushButton ("Best Graph", this));
        }
...
//    }
    ...
    QObject::connect (m_load_default_5_button, &QPushButton::clicked, this, [this] () { Q_EMIT load_default_5_signal (); });
    QObject::connect (m_load_default_6_button, &QPushButton::clicked, this, [this] () { Q_EMIT load_default_6_signal (); });
}
